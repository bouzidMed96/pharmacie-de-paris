...
export default function App() {
  ...
  const [activeTab, setActiveTab] = useState<"shop" | "account">("shop");
  ...
  // Authentication & Profile State (Persisted in localStorage in simple sandbox mode)
  const [isLoggedIn, setIsLoggedIn] = useState(true); // Default logged-in for high quality client test
    ...
    orders: [
      {
        ...
        storeLocation: "Citypharma Paris 6e (26 Rue du Four, 75006 Paris)",
        paymentMethod: "card",
      ...
      <footer className="bg-emerald-950 text-white font-sans text-xs border-t border-emerald-900 py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-3">
            <h4 className="font-extrabold text-sm uppercase text-emerald-300 tracking-wider">A propos de ParisPharma</h4>
            <p className="text-emerald-100 leading-relaxed text-[11px]">
              Inspiré de l'excellence de Citypharma à Paris, notre portail web moderne vous permet de commander vos soins favoris et vos ordonnances médicales en toute sérénité. Retrait rapide en pharmacie de garde ou livraison soignée à domicile.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="text-[11px] text-emerald-100 space-y-2">
              <div className="flex items-center gap-2">
                ...
                <span>26 Rue du Four, 75006 Paris</span>
              </div>
              <div className="flex items-center gap-2">
                <Clock className="w-4 h-4 text-emerald-400" />
                <span>Ouvert 24h/24, 7j/7 sans interruption</span>
              </div>
              <div className="flex items-center gap-2">
                <ShieldCheck className="w-4 h-4 text-emerald-400" />
                <span>Agrément ARS Île-de-France (N° 75/12)</span>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 border-t border-emerald-900 mt-8 pt-6 flex flex-col sm:flex-row justify-between items-center text-emerald-300 text-[11px] gap-2">
          <span>© 2026 ParisPharma Officine &amp; Parapharmacie S.A.S. Tous droits réservés.</span>
