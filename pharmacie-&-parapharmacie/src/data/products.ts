...
export const STORES_LIST = [
  "Citypharma Paris 6e (26 Rue du Four, 75006 Paris)",
  "Pharmacie de la Bastille (Boulevard Richard-Lenoir, 75011 Paris)",
  "Pharmacie du Marais (Rue des Archives, 75003 Paris)",
  "Pharmacie de l'Opéra (Avenue de l'Opéra, 75001 Paris)",
  "Pharmacie des Champs-Élysées (Avenue des Champs-Élysées, 75008 Paris)"
];
